...
OrgChart.prototype._draw = function(t, v, x, y) {
    ...
    this.server.read(t, this.width(), this.height(), e, v, x, function(t) {
        ...
        for (var n in OrgChart.events.publish("prerender", [b, e]),
        r = e.content,
        t.visibleNodes) {
        ...
        v !== OrgChart.action.exporting) {
            v !== OrgChart.action.centerNode && v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update || (o = a),
            v === OrgChart.action.init && null != a && (o = a),
            b.response = t;
            ...
            v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), {
                ...
                b.xScrollUI.setPosition(),
                b.yScrollUI.setPosition()
            }) : !a || !b.response || a[0] == b.response.viewBox[0] && a[1] == b.response.viewBox[1] && a[2] == b.response.viewBox[2] && a[3] == b.response.viewBox[3] || v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update && v !== OrgChart.action.init ? 0 == p[0].length && (g || (y && y(),
            OrgChart.events.publish("redraw", [b]),
            ...
            b._initialized || (b._initialized = !0,
            OrgChart.events.publish("init", [b]))
        } else {
            var u = t.boundary
              , C = u.maxX - u.minX
              , m = u.maxY - u.minY
...
OrgChart.prototype.group = function(t, e, r) {
    if (!0 === r && !1 === OrgChart.events.publish("group", [this, t, e]))
        return !1;
    var i = this.getBGNode(t)
      , a = this.getBGNode(e)
      , o = a.id;
    if (i.isGroup || a.isGroup || i.isChildOfGroup || a.isChildOfGroup)
        if (i.isGroup || a.isGroup || !i.isChildOfGroup || a.isChildOfGroup)
            if (i.isGroup || a.isGroup || i.isChildOfGroup || !a.isChildOfGroup)
                if (!i.isGroup && !a.isGroup && i.isChildOfGroup && a.isChildOfGroup)
                    this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id),
                    this.removeNodeTag(i.id, i._groupParentNodeId, !0),
                    this.addNodeTag(i.id, a._groupParentNodeId, !0),
                    this.link(i.id, a.pid);
                else if (!i.isGroup && a.isGroup && i.isChildOfGroup && !a.isChildOfGroup)
                    this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id),
                    this.removeNodeTag(i.id, i._groupParentNodeId, !0),
                    this.addNodeTag(i.id, a.id, !0);
                else if (i.isGroup || !a.isGroup || i.isChildOfGroup || a.isChildOfGroup) {
                    if (i.isGroup && a.isGroup && !i.isChildOfGroup && !a.isChildOfGroup)
                        for (var n = 0; n < i.bgnodes.length; n++)
                            this.removeNodeTag(i.bgnodes[n].id, i.id, !0),
                            this.addNodeTag(i.bgnodes[n].id, a.id, !0)
                } else
                    this.addNodeTag(i.id, a.id, !0);
            else
                this.addNodeTag(i.id, a._groupParentNodeId, !0),
            ...
            this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id),
            this.removeNodeTag(i.id, i._groupParentNodeId, !0),
            this.addNodeTag(i.id, l, !0),
            this.addNodeTag(a.id, l, !0)
        }
    else {
...
OrgChart.editUI.prototype._createDetailsView = function(t, e) {
    ...
    for (var h = 0; h < l.length; h++) {
        ...
        OrgChart._fieldIsImg(this.obj.config, l[h])) {
            ...
            this._addField(o, OrgChart.input(l[h], d, null, !0), l[h], "details")
    }
    ...
    for (var c = 0; c < h.length; c++) {
        ...
        "tags" != h[c])
            if (OrgChart._fieldIsImg(this.obj.config, h[c])) {
                ...
                this._addField(n, OrgChart.input(h[c], g, null, !1), h[c], "edit")
    }
...
OrgChart.toolbarUI.prototype.init = function(t, e) {
    if (e) {
        ...
        this.layouts.innerHTML = '<svg data-layout="normal" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#e23e89" x="7" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="63" y="41" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="88" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="32" y1="35" y2="41" stroke-width="1"></line><line stroke="#000000" x1="88" x2="88" y1="35" y2="41" stroke-width="1"></line></svg><svg data-layout="treeRightOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#e23e89" x="40" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="40" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="35" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="35" x2="35" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#e23e89" x="30" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="mixed" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#e23e89" x="35" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="35" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="41" stroke-width="1"></line><line stroke="#000000" x1="60" x2="60" y1="68" y2="73" stroke-width="1"></line></svg><svg data-layout="tree" style="cursor: pointer;" width="110" height="100"><rect fill="#039BE5" x="35" y="0" width="50" height="27"></rect><rect fill="#e23e89" x="7" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="7" y="73" width="50" height="27"></rect><rect fill="#e23e89" x="63" y="41" width="50" height="27"></rect><rect fill="#e23e89" x="63" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="86" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="54" y2="54" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="86" y2="86" stroke-width="1"></line></svg>',
...
OrgChart.icon.search = function(t, e) {
    return '<svg width="' + t + '" height="' + e + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 485.213 485.213"><path fill="#513278" d="M471.882,407.567L360.567,296.243c-16.586,25.795-38.536,47.734-64.331,64.321l111.324,111.324 c17.772,17.768,46.587,17.768,64.321,0C489.654,454.149,489.654,425.334,471.882,407.567z" /><path fill="#513278" d="M363.909,181.955C363.909,81.473,282.44,0,181.956,0C81.474,0,0.001,81.473,0.001,181.955s81.473,181.951,181.955,181.951 C282.44,363.906,363.909,282.437,363.909,181.955z M181.956,318.416c-75.252,0-136.465-61.208-136.465-136.46 c0-75.252,61.213-136.465,136.465-136.465c75.25,0,136.468,61.213,136.468,136.465 C318.424,257.208,257.206,318.416,181.956,318.416z" /><path fill="#513278" d="M75.817,181.955h30.322c0-41.803,34.014-75.814,75.816-75.814V75.816C123.438,75.816,75.817,123.437,75.817,181.955z" /></svg>'
}
,
    ...
    this._draw(!1, OrgChart.action.exporting, t, function(t) {
        ...
        "svg" == a.ext)
            if (o)
                ...
                if (!1 === i)
                    return !1;
                if (OrgChart._downloadFile(a.mime, e.content, e.options.filename),
            ...
            OrgChart._imgs2base64(r, "image", "xlink:href", function() {
                n._pages(a, r.querySelector("svg"), function(t) {
                    ...
                    OrgChart._ajax(n.config.exportUrl + "/v3", "POST", e, "arraybuffer", function(t) {
                        ...
                        OrgChart._downloadFile(a.mime, t, a.filename)
                    }))
                })
            })
    })
        ...
        function(r) {
            s._draw(!1, OrgChart.action.exporting, t, function(t) {
                ...
                OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                    ...
                    g.length - 1 == o && (s.config.collapse = h,
                    s.config.roots = d,
                    l(c))
                })
            })
    ...
    if (this.config.enableDragDrop) {
        ...
        if (!1 !== OrgChart.events.publish("drag", [this, i])) {
            ...
            var O = function(t, e) {
                if (null != t) {
                    var r = d.getBGNode(t);
                    r.isChildOfGroup && (d.getNodeElement(r._groupParentNodeId).style.opacity = 1),
                    e.style.opacity = 1
                }
            }
              , v = function(t) {
                ...
                if (null != s) {
                    var a = d.getBGNode(s);
                    a.isChildOfGroup && (d.getNodeElement(a._groupParentNodeId).style.opacity = .8),
                    h.style.opacity = .5
                }
                var o = (e.x - g.x) / C
                  , n = (e.y - g.y) / C;
              ...
              , x = function(t) {
                if (c.removeEventListener(n.move, v),
...
OrgChart.searchUI.createInputField = function(t) {
    return '<div id="search-box" data-id="search" style="border-radius: 20px 20px;padding:5px; box-shadow: #513278 0px 1px 2px 0px; font-family:Roboto-Regular, Helvetica;color:#7a7a7a;font-size:14px;border:1px solid #513278;width:300px;position:absolute;top:' + (t-30) + "px;right:" + (t+100) + 'px;background-color:#ffffff;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32) + '</div><div data-id="cell-1" style="float:right; width:83%"><input placeholder="' + OrgChart.SEARCH_PLACEHOLDER + '" style="font-size:16px;color:#513278;width:100%;border:none;outline:none; padding-top:10px;" type="text" /></div><div style="clear:both;"></div></div><div data-id="container"></div></div>'
}
,
...
OrgChart.searchUI.createSearchIcon = function(t) {
    return '<div id="search-icon" data-id="search-icon" style="padding:5px; position:absolute;top:' + (t-30) + "px;right:" + (t+100) + 'px;border:1px solid transparent;"><div><div style="float:left;">' + OrgChart.icon.search(32, 32) + "</div></div></div>"
}
,
void 0 === OrgChart && (OrgChart = {}),
...
OrgChart.server._createNodes = function(t, e, r, i) {
    for (var a = t.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        ...
        null != f) {
            if (!o[f.name]) {
                ...
                C.isGroup = !0,
                null != t.orderBy && (C.order = g[t.orderBy]),
                o[f.name] = C
            }
            v.isChildOfGroup = !0,
    ...
    for (c = 0; c < n.length; c++) {
        ...
        if (null != v.pid && null != v.pid && "" !== v.pid)
            (w = o[v.pid]) ? ((v.parent = w).children.push(v),
            w.childrenIds.push(v.id)) : (v.pid = null,
            v.parent = null,
            l.push(v));
        else
            l.push(v);
        e == OrgChart.action.exporting && null != r.id && (l = [o[r.id]]),
        x ? (v.state = x.state,
        ...
        OrgChart.server._initStates(v, o, e, t, r, m),
        OrgChart.server._initGroupStates(v, o, e, t, r)
    }
    if (null != t.roots) {
        l = [];
            ...
            if (y) {
                if (y.parent)
                    for (var b = (w = y.parent).children.length - 1; 0 <= b; b--) {
                        (z = w.children[b]) == y && (z.parent = null,
                        w.children.splice(b, 1),
                        w.childrenIds.splice(b, 1))
                    }
                l.push(y)
            }
        }
    ...
    for (c = 0; c < s.length; c++) {
        ...
        (x = i[_.id]) && (o[_.id].state = x.state,
        o[_.id].state == OrgChart.COLLAPSE && m.push(_.id)),
        OrgChart.server._initStates(_, o, e, t, r, m);
        var k = [];
        for (b = w.children.length - 1; 0 <= b; b--) {
            (z = w.children[b]).isAssistant ? (z.parent = null,
            w.children.splice(b, 1),
            w.childrenIds.splice(b, 1),
            k.splice(0, 0, z.id)) : (z.pid = _.id,
            (z.parent = _).children.push(z),
            _.childrenIds.push(z.id),
            w.children.splice(b, 1))
        }
        if (k.length % 2) {
            ...
            (V = new OrgChart.node(w.id + "_transperant",A.pid,[],I)).isAssistant = !0,
            o[V.id] = V,
            k.splice(k.length - 1, 0, V.id)
        }
        var N = 1;
        for (b = k.length - 1; 0 <= b; b--) {
            if (b % 2 && b != k.length - 1)
                (W = new OrgChart.node(w.id + "_split_" + N,null,[],"split")).isAssistant = !0,
                o[W.id] = W,
                k.splice(b, 0, W.id),
                N++;
            else
    ...
    for (c = 0; c < m.length; c++) {
        if (w = (v = o[m[c]]).parent)
            for (b = w.children.length - 1; 0 <= b; b--) {
                if (w.children[b] == v)
                    if (-1 == w.collapsedChildrenIds.indexOf(v.id) && w.collapsedChildrenIds.push(v.id),
                    w.children.splice(b, 1),
                    "split" == v.templateName || "split" == w.templateName) {
                        if (M = v.parent) {
                            for (; "split" == M.templateName; )
                                M = M.parent;
                            for (var G = 0; G < M.childrenIds.length; G++) {
                                var X = M.childrenIds[G];
    ...
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        ...
        for (c = 0; c < n.length; c++) {
            if (0 == (v = o[n[c]]).childrenIds.length && !v.isAssistant && "split" != v.templateName)
                (w = v.parent) && -1 == Y.indexOf(w.id) && Y.push(w.id)
        }
        for (c = 0; c < Y.length; c++) {
                ...
                if (OrgChart.server._mixedLayoutAllNodes(w))
                    if (0 == (z = w.children[b]).childrenIds.length && !z.isAssistant && "split" != z.templateName && (z.parent && "split" != z.parent.templateName || z.parent.isAssistant)) {
                        ...
                        t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                            ...
                            (V = new OrgChart.node(z.id + "_transperant",null,[],I)).layout = OrgChart.tree,
                            o[V.id] = V,
                            q.splice(0, 0, V.id)
                        }
                        t.layout != OrgChart.treeRightOffset && q.splice(0, 0, z.id)
            ...
            b = q.length - 1; 0 <= b; b--) {
                var W;
                if (b % 2 && b != q.length - 1)
                    (W = new OrgChart.node(w.id + "_split_" + N,null,[],"split")).layout = OrgChart.tree,
                    o[W.id] = W,
                    q.splice(b, 0, W.id),
                    N++;
                else
                    b % 2 && q.splice(b, 0, _.id)
            }
            for (b = 0; b < q.length; b += 3) {
                ...
                E.pid = M.id,
                M.children.push(E),
                w.childrenIds.push(E.id),
                L && (0 != b && (M = o[q[b - 2]]),
                L.parent = M,
                L.pid = M.id,
                M.children.push(L),
                w.childrenIds.push(L.id)),
                B && (0 != b && (M = o[q[b - 1]]),
                B.parent = M,
                B.pid = M.id,
                M.children.push(B),
                w.childrenIds.push(B.id))
            }
        }
    }
    return {
        ...
        if (0 == i.layout_type)
            ...
            case OrgChart.orientation.bottom_left:
                ...
                for (var c = 0; c < t.bgnodes.length; c++)
                    ...
                    o += t.bgnodes[c].h + i.groupNodesSeparation;
                o -= i.groupNodesSeparation,
                a = h;
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
        ...
        if (0 == r.layout_type)
            ...
            case OrgChart.orientation.bottom_left:
                for (var o = 0, n = 0; n < t.bgnodes.length; n++) {
                    (s = t.bgnodes[n]).x = t._groupSettings._cellWidth / 2 - s.w / 2,
                    s.y = t._groupSettings._cellHeight / 2 - s.h / 2 + o,
                    o += s.h + r.groupNodesSeparation
                }
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            ...
            case OrgChart.orientation.left_top:
                ...
                for (n = 0; n < t.bgnodes.length; n++) {
                    (s = t.bgnodes[n]).y = t._groupSettings._cellHeight / 2 - s.h / 2,
            ...
            for (n = 0; n < t.bgnodes.length; n++) {
                var s;
                (s = t.bgnodes[n]).x = t._groupSettings._cellWidth / 2 - s.w / 2 + r.groupNodesSeparation + (t._groupSettings._cellWidth * i + r.groupNodesSeparation * i),
...
OrgChart.templates.rony.svg = '<svg id="tree-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;margin-top:0px" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>',
...
OrgChart.templates.rony.node = '<rect x="0" y="0" filter="url(#{randId})" height="250" width="180" fill="#ffffff" stroke-width="0" rx="5" ry="5"></rect><line x1="0" y1="0" x2="180" y2="0" stroke-width="5" stroke="#e23e89"></line>',
OrgChart.templates.rony.field_0 = '<text width="165" class="field_0" style="font-size: 27px;" fill="#513278" x="90" y="40" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.field_1 = '<text width="165" class="field_1" style="font-size: 18px;" fill="#e23e89" x="90" y="70" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.field_2 = '<text width="165" style="font-size: 14px;" fill="#FFCA28" x="90" y="80" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.link = '<path stroke="#513278" stroke-width="1px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>',
OrgChart.templates.rony.plus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#513278" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#513278"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#513278"></line>',
OrgChart.templates.rony.minus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#513278" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#513278"></line>',
OrgChart.templates.rony.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,155,235)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#e23e89"></circle><circle cx="7" cy="0" r="2" fill="#e23e89"></circle><circle cx="14" cy="0" r="2" fill="#e23e89"></circle></g>',
OrgChart.templates.rony.exportMenuButton = '<div style="position:absolute;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer;" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
...
OrgChart.templates.derek.field_0 = '<text width="235" class="field_0"  style="font-size: 24px;" fill="#00548a" x="125" y="90" text-anchor="middle">{val}</text>',
...
OrgChart.templates.isla.minus = '<circle cx="15" cy="15" r="15" fill="#e23e89" stroke="#e23e89" stroke-width="1"></circle><line x1="8" y1="15" x2="22" y2="15" stroke-width="1" stroke="#ffffff"></line>',
...
OrgChart.ui = {
    ...
    expandCollapse: function(t, e, r, i) {
        ...
        return o -= l.expandCollapseSize / 2,
        n -= l.expandCollapseSize / 2,
        t.collapsedChildrenIds.length ? (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", n),
        a += l.plus) : (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", n),
        a += l.minus),
...
OrgChart.wrapText = function(t, e) {
    ...
    if ("multiline" == s) {
        ...
        u.setAttributeNS(null, "y", o),
        u.setAttributeNS(null, "text-anchor", n),
        u.appendChild(C),
        d.appendChild(u);
        g = 1;
        ...
        if (null != d.innerHTML)
            ...
            for (m = d.childNodes.length - 1; 0 <= m; m--)
                x = XMLSerializer().serializeToString(d.childNodes[m]) + x,
...
OrgChart.loading.show = function(t) {
    var e = document.createElement("div");
    e.id = "bg-loading",
    e.innerHTML = '<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.bg-loading-dots div {margin: 10px;}      .bg-dot-1 {background-color: #039BE5;}.bg-dot-2 {background-color: #e23e89;}.bg-dot-3 {background-color: #FFCA28;}      .bg-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.bg-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.bg-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.bg-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="bg-loading-dots"><div class="bg-loading-dots--dot bg-dot-1"></div><div class="bg-loading-dots--dot bg-dot-2"></div><div class="bg-loading-dots--dot bg-dot-3"></div></div>',
...
OrgChart.prototype._clink = function(t, e) {
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (e.res.visibleNodes[h.from] && e.res.visibleNodes[h.to]) {
            ...
            h.label && (l += m.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", h.label)),
...
OrgChart.clinkTemplates.orange = {
    defs: '<marker id="arrowOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#e23e89" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#e23e89" /></marker>',
    link: '<path marker-start="url(#dotOrange)" marker-end="url(#arrowOrange)" stroke="#e23e89" stroke-width="2" fill="none" d="{d}" />',
    label: '<text fill="#e23e89" text-anchor="middle" x="{x}" y="{y}">{val}</text>'
},
...
OrgChart.prototype._slinks = function(w, _) {
    ...
    function t(t, e) {
        ...
        if (t.level == e.level)
            switch (i = e,
            w.config.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
                r.push([l.p, l.q]),
                r.push([l.p, l.q - n / 3]),
                o = OrgChart.t(i.templateName, A),
                r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]),
                r.push([r[r.length - 1][0], i.y]);
                break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                l.q = t.y + t.h,
                l.s = S.maxY - n,
                r.push([l.p, l.q]),
                r.push([l.r, t.y + t.h + n / 3]),
                o = OrgChart.t(i.templateName, A),
                r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]),
                r.push([r[r.length - 1][0], i.y + i.h]);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                l.p = t.x,
                l.q = t.y + t.h / 2 + o.expandCollapseSize,
                l.r = S.minX - n,
                l.s = t.y + t.h / 2 + o.expandCollapseSize,
                r.push([l.p, l.q]),
                r.push([t.x - n / 3, l.q]),
                o = OrgChart.t(i.templateName, A),
                r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]),
                r.push([i.x, r[r.length - 1][1]]);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                l.p = t.x + t.w,
                ...
                l.s = t.y + t.h / 2 + o.expandCollapseSize,
                r.push([l.p, l.q]),
                r.push([t.x + t.w + n / 3, l.q]),
                o = OrgChart.t(i.templateName, A),
                r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]),
                r.push([i.x + i.w, r[r.length - 1][1]])
            }
        else {
            switch (w.config.orientation) {
            case OrgChart.orientation.top:
            ...
            for (var s = t; null == i; ) {
                var h = !1
                  ...
                  , c = d.leftNeighbor
                  , g = d.rightNeighbor;
                if (d.id == e.id ? i = d : OrgChart._intersects(d, l, w.config) && (l = OrgChart._addPoint(d, r, w.config, l, a),
                h = !0),
                d.id != e.id) {
                    for (; c; ) {
                        if (c.id == e.id) {
                        ...
                        OrgChart._intersects(c, l, w.config) && (l = OrgChart._addPoint(c, r, w.config, l, a),
                        h = !0),
                        c = c.leftNeighbor
                    }
                    for (; g; ) {
                        ...
                        OrgChart._intersects(g, l, w.config) && (l = OrgChart._addPoint(g, r, w.config, l, a),
                        h = !0),
                        g = g.rightNeighbor
                    }
                }
                if (!h) {
                    var p = r[r.length - 1][0]
                      , f = 0;
                    if (d.parent)
                        switch (n = w.config.levelSeparation,
                        d.parent.layout != OrgChart.mixed && d.parent.layout != OrgChart.tree || (n = w.config.mixedHierarchyNodesSeparation),
                        w.config.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
            ...
            switch (o = OrgChart.t(i.templateName, A),
        ...
        for (var O = 1; O < r.length; O++)
            r[O] = "L" + r[O].join(",");
        var v = r.join(" ");
        if (k += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + o.link.replace("{d}", v),
        I.label) {
...
OrgChart.slinkTemplates.orange = {
    defs: '<marker id="arrowSlinkOrange" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#e23e89" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkOrange" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#e23e89" /></marker>',
    link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkOrange)" marker-end="url(#arrowSlinkOrange)" stroke-linejoin="round" stroke="#e23e89" stroke-width="2" fill="none" d="{d}" />',
    label: '<text dominant-baseline="middle" fill="#e23e89" alignment-baseline="middle" text-anchor="middle" x="{x}" y="{y}">{val}</text>',

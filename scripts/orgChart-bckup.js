...
OrgChart.templates.ula.field_0 = '<text width="145" class="field_0" style="font-size: 25px;" fill="#000080" x="100" y="55">{val}</text>',
...
OrgChart.templates.ula.node = '<rect x="0" y="0" height="120" width="250" fill="#ffffff" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="250" y2="0" stroke-width="5" stroke="#ff6600"></line>',
...
OrgChart.templates.rony.node = '<rect x="0" y="0" filter="url(#{randId})" height="250" width="180" fill="#ffffff" stroke-width="0" rx="5" ry="5"></rect>',
OrgChart.templates.rony.field_0 = '<text width="165" class="field_0" style="font-size: 27px;" fill="#000080" x="90" y="40" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.field_1 = '<text width="165" class="field_1" style="font-size: 18px;" fill="#F57C00" x="90" y="70" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.field_2 = '<text width="165" style="font-size: 14px;" fill="#FFCA28" x="90" y="80" text-anchor="middle">{val}</text>',
OrgChart.templates.rony.link = '<path stroke="#000080" stroke-width="1px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>',
OrgChart.templates.rony.plus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#000080" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#000080"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#000080"></line>',
OrgChart.templates.rony.minus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#000080" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#000080"></line>',

...
window.onload = function () {
    ...
    OrgChart.templates.MyTemplate.node = '<rect x="25" y="0" height="200" width="250" fill="#ffffff" stroke-width="4" stroke="#004165" rx="50" ry="50"></rect>';
    ...
    OrgChart.templates.MyTemplate.name = '<text width="220" style="font-size: 24px;font-weight:bold;font-family: Helvetica;" fill="#4D4E53" x="150" y="115" text-anchor="middle">{val}</text>';
    ...
    chart.load([
       ...
       {id: 3, pid: 0, Name: 'Ashley Barnett', Title: 'Alternate Title', Email: 'jdoe@tifs.com', Phone: '1 888 888 8888', Mobile: '1 999 999 9999', Division: 'Division Code', Region: 'NA', Country: 'United States', Location: 'Corporate', Headquorters: '', Coy: 963, Supervisor: 'Tim Doe', 'Dotted Line': 'Jane Doe', Image: 'https://balkangraph.com/js/img/4.jpg'},
        {id: 4, pid: 0, Name: 'Elliot Patel', Title: 'Alternate Title', Email: 'jdoe@tifs.com', Phone: '1 888 888 8888', Mobile: '1 999 999 9999', Division: 'Division Code', Region: 'NA', Country: 'United States', Location: 'Corporate', Headquorters: '', Coy: 963, Supervisor: 'Tim Doe', 'Dotted Line': 'Jane Doe', Image: 'https://balkangraph.com/js/img/5.jpg'},
